...
- Lecteur de logs et Contrôle des liens : plus de trait de séparation entre le tableau et le détail, un peu plus d'espace entre les deux (la séparation reste déplaçable).
